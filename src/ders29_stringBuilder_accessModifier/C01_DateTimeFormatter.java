...
public class C01_DateTimeFormatter {
    public static void main(String[] args) {
        ...
        System.out.println(zaman); //2022-11-23T12:44:59.974037300

        DateTimeFormatter dtf1= DateTimeFormatter.ofPattern("dd/MM/YYYY");

        System.out.println(zaman.format(dtf1));//23/11/2022

        DateTimeFormatter dtf2= DateTimeFormatter.ofPattern("d:MMM:YY");

        System.out.println(zaman.format(dtf2)); //23:Kas:22

        DateTimeFormatter dtf3= DateTimeFormatter.ofPattern("d.MMMM.YYYY EEEE");

        System.out.println(zaman.format(dtf3)); //23.Kasım.2022 Çarşamba

        DateTimeFormatter dtf4= DateTimeFormatter.ofPattern("hh:mm a");

        System.out.println(zaman.format(dtf4)); //12:51 ÖS
