...
public class C06_substring {
    public static void main(String[] args) {
        ...
        System.out.println(str.substring(0));// hepsini yazdirir Java ogren, isi kap

        System.out.println(str.length()); //19

        // son karakteri String olarak kaydedin
       String sonHarf=""+ str.charAt(str.length()-1);//"" string yapmak icin kullandik

       sonHarf= str.substring(str.length()-1); //yukardakini uygulamadan string yapma yontemi
