...
public class C05_WrapperClass {
    public static void main(String[] args) {
        ...
        /*
        primitive data turleri sadece deger barındırırlar, hazir metodları yoktur
        ...
        //Integer.parseInt(str) icine yazilan str rakamlardan olusuyorsa str'i int'a cevir
